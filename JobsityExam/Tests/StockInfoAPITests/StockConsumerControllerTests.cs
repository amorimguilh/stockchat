...
using StockConsumer.Controllers;
...
{
    [TestClass]
    public class StockConsumerControllerTests
    {
        private readonly StockConsumerController _controller;
        ...
        public async Task WhenCallingGetMethod_PassingAValidStockName_ShouldReturnTheExpectedSucessMessage()
        {
            ...
            // Call
            await _controller.Get(new StockConsumerRequest { StockName = stockName } );
